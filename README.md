...
Тест проверяет базовый сценарий посуточной аренды из документа, границы пользовательского ввода, минимальный первоначальный взнос (30% от стоимости квартиры), потолок в 2 квартиры в ипотеку одновременно и модель «Сдаю сам».
